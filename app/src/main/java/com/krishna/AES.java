...
public class AES extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    // outputstring was there in place of inptext
                    output_text.setText(outputstring);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(com.krishna.AES.this, ResetPassword.class);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (outputstring.length() > 0) {
                    ...
                    Toast.makeText(com.krishna.AES.this, "Empty Output", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private String encrypt(String data, String password_text) throws Exception {
        ...
        //Log.d("VISHNU", "encrypt key:" + key.toString());
